...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      console.log("setOpen called, new value:", openState)
      if (setOpenProp) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "fixed inset-y-0 z-50 h-svh transition-[left,right,width] duration-200 ease-linear data-[side=left]:left-0 data-[side=right]:right-0 md:flex max-md:hidden",
          // Width styling
          isCollapsed && collapsible === "icon"
            ? (variant === "floating" || variant === "inset"
                ? "w-16"
